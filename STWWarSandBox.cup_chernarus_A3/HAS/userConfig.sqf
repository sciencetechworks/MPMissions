...
RYD_HAS_VoiceChat = true;//if there should be played kbTell sentences (if available). If false - sidechat text sentences will be used instead (no voice, but better coverage). Ignored for supply drop - text chat only
